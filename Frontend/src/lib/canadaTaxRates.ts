...
/** Normalizes a stored taxLabel for display — older invoices may have saved "GST+PST" before the "/" format. */
export function displayTaxLabel(label?: string | null): string {
